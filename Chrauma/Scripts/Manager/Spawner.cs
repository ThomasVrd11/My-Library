...
public class Spawner : MonoBehaviour
{
    ...
    private void Awake()
    {
        // * Initialize the enemy pool and pre-spawn enemies
    ...
    // * Pre-spawn enemies and release them to the pool
    ...
    // * On getting an enemy from the pool, reset its health
    ...
    // * On releasing an enemy to the pool, deactivate it and update counters
    ...
    void Update()
    {
        // * Check if spawning conditions are met and spawn enemies accordingly
    ...
    {
        // * Get a valid NavMesh position near the given position
        NavMeshHit hit;
